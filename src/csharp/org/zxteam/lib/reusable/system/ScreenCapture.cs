namespace org.zxteam.lib.reusable.system
{
	...
	public class ScreenCapture
	{
		...
		public Image CaptureScreen()
		{
			...
			int screenLeft = virtualScreen.Left;
			int screenTop = virtualScreen.Top;
		...
		{
			MakeDirectoryForFileIfNotExist(filename);
		...
		private void MakeDirectoryForFileIfNotExist(string filename)
		{
